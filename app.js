...
$('#addFicha').onclick=()=>addFicha();$('#demoBtn').onclick=()=>{state.files=[];state.result=null;$('#files').value='';$('#zipFiles').value='';renderFiles();showZipStatus('');$('#summary').classList.add('hidden');$('#actions').classList.add('hidden');setStatus('Carga los archivos y presiona “Procesar conciliación”.','muted')};
const dz=$('#dropZone');
